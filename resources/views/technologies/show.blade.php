...
@section('content')
    <div class="container">
        <h2 class="my-4">{{ $technology->name }}</h2>

        <div class="row mb-3">
            <div class="col-auto">
                <a href="{{ route('technologies.edit', $technology) }}" class="btn btn-outline-warning">Edit</a>
            </div>
            <div class="col-auto">
        ...
        <div class="row gap-3">
            ...
            <div class="col-12">
                <a href="{{ route('technologies.index') }}">Back to index</a>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure to <strong>permanently delete</strong> this technology?
                </div>
